...
//	자유 게시판 총 게시글 조회 
	...
	// 프로필 수정
	@Override
	public boolean updateProfile(Integer mNo, String[] hope, String[] stack, String intro, String nickname,
		...
		int updatedRows = mypageDao.updateProfile(mNo, hopeString, stackString, intro, nickname, email, number,
