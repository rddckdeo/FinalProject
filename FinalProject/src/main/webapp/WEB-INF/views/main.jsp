					...
					<div class="col-md-8 col-lg-6 col-xxl-3 minWidth1200">
						...
						<div class="card mb-0 height600">
                           ...
                           <div class="direction1 alignCenter justifyCenter">
                              <a class="totalBtn Margin20 borderRadiusd backBlue2 direction1 sortCenter" 
                              href="#"> 협업 홈페이지<br>
                                 <small class="small15">협업으로 바로가기~</small>
                              </a>                           
                           </div>
                           <div class="direction1 alignCenter justifyCenter">
                              <a class="totalBtn Margin20 borderRadiusd backRed2 direction1 sortCenter" 
                              href="/board/"> 게시판 홈페이지<br>
                                 <small class="small15">게시판으로 바로가기~</small>
                              </a>                           
                           </div>
                        </div>
							</div>
