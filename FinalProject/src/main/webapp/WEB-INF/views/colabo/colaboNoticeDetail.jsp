         ...
         <br>
			...
			<div class="mb-3 justify-content-center">
				<input type="text" class="form-control"
					name="noticeTitle" id="exampleFormControlInput1" value="${list.noticeTitle}" readOnly>
			</div>
			<div id="marteditor mb-3 justify-content-center">
				<textarea name="noticeContent" id="editorTxt" class="form-control"
					rows="13" cols="10" readOnly>${list.noticeContent}</textarea>
			</div>
...
<!-- 			<input type="file" name="upload"/> -->
			...
			<div class="row">
				<div class="col text-center">
					...
					<button type="button" onclick="enterEdit(${list.noticeNo})" class="btn btn-primary">글 수정</button>
					<button type="button" onclick="deleteNotice(${list.noticeNo})" class="btn btn-danger">글 삭제</button>
				</div>
			</div>
