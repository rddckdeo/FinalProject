				...
				<nav class="navbar navbar-expand-lg">
					<div class="navbar-collapse justify-content-end px-0"
						...
						<ul
							...
							<a href="#" target="_blank" id="header-bell"><img
								src="../../../../resources/uploads/icon/bell.png" alt="" width="33" height="33"></a>
							<a href="#" target="_blank" id="header-chat"><img
								src="../../../../resources/uploads/icon/message.png" alt="" width="31" height="31"></a>
							<li class="nav-item dropdown"><a
								class="nav-link nav-icon-hover" href="#" id="drop2"
								data-bs-toggle="dropdown" aria-expanded="false"> <img
									src="" alt="" width="35" height="35"
