...
<nav class="sidebar-nav">
    <ul id="sidebarnav" class="mb-4 pb-2">
        ...
        <li class="sidebar-item"><a
            ...
            href="/info/category?name=framework&page=1&sortType=date" aria-expanded="false">
                <span class="aside-icon p-2 bg-light-danger rounded-3"> <i
                    class="ti ti-alert-circle fs-7 text-danger"></i>
						...
						<li class="sidebar-item"><a
							...
							href="/info/category?name=database&page=1&sortType=date" aria-expanded="false">
						...
						<li class="sidebar-item"><a
							...
							href="/info/category?name=webDev&page=1&sortType=date" aria-expanded="false">
						...
						<li class="sidebar-item"><a
							...
							href="/info/category?name=mobileDev&page=1&sortType=date" aria-expanded="false">
								<span class="aside-icon p-2 bg-light-indigo rounded-3"> <i
						...
						<li class="sidebar-item"><a
							class="sidebar-link sidebar-link indigo-hover-bg"
							href="/info/category?name=cloud&page=1&sortType=date" aria-expanded="false">
								<span class="aside-icon p-2 bg-light-indigo rounded-3"> <i
									class="ti ti-typography fs-7 text-indigo"></i>
						...
						<li class="sidebar-item"><a
							class="sidebar-link sidebar-link indigo-hover-bg"
							href="/info/category?name=devTools&page=1&sortType=date" aria-expanded="false">
								<span class="aside-icon p-2 bg-light-indigo rounded-3"> <i
									class="ti ti-typography fs-7 text-indigo"></i>
						...
						<li class="sidebar-item"><a
							class="sidebar-link sidebar-link indigo-hover-bg"
							href="/info/category?name=portfolio&page=1&sortType=date" aria-expanded="false">
								<span class="aside-icon p-2 bg-light-indigo rounded-3"> <i
									class="ti ti-typography fs-7 text-indigo"></i>
						...
						<li class="sidebar-item"><a
							class="sidebar-link sidebar-link warning-hover-bg"
							 href="/free/category?name=daily&page=1&sortType=date" aria-expanded="false"> <span
								class="aside-icon p-2 bg-light-warning rounded-3"> <i
									class="ti ti-article fs-7 text-warning"></i>
						...
						<li class="sidebar-item"><a
							class="sidebar-link sidebar-link danger-hover-bg"
							href="/free/category?name=informationy&page=1&sortType=date" aria-expanded="false">
								<span class="aside-icon p-2 bg-light-danger rounded-3"> <i
									class="ti ti-alert-circle fs-7 text-danger"></i>
						...
						<li class="sidebar-item"><a
							class="sidebar-link sidebar-link success-hover-bg"
							href="/free/category?name=hobby&page=1&sortType=date" aria-expanded="false"> <span
						...
						<li class="sidebar-item"><a
							class="sidebar-link sidebar-link primary-hover-bg"
							href="/free/category?name=review&page=1&sortType=date" aria-expanded="false"> <span
