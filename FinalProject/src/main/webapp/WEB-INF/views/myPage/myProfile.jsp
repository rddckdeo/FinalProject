							...
							<div class="container-fluid">
								...
								<div class="card">
									...
									<div class="card-body height500 direction1" style="padding-top: 0;">
										<!-- 프로필 이미지, 이름, 희망 직무 등 -->
										<div class="justifyCenter width100 height200 direction2 padding30 ">
											<img src="${sessionScope.path}${sessionScope.picture}" alt="" class="profileImg">
											<div class="width100 height200 direction2 padding30">
												...
												<div class="profileP justifyCenter direction1">
													...
													<c:choose>
														<c:when test="${!empty sessionScope.stack}">
														<p class="bottomMargin20 leftMargin20">${sessionScope.hope}</p>
														</c:when>
														<c:otherwise>
													...
													<c:choose>
														<c:when test="${!empty sessionScope.stack}">
														<p class="bottomMargin20 leftMargin20">${sessionScope.stack}</p>
														</c:when>
														<c:otherwise>
										...
										<!-- 소개 -->
										<div class="width100 padding30 height200 boxShadow borderDefault bottomMargin20">
											<h1>소개글</h1>
											<p class="small15">나는 문어 꿈을 꾸는 문어</p>
										</div>
										<!-- 참여한 프로젝트 -->
