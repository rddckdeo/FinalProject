		...
		<nav class="navbar navbar-expand-lg">
			<div class="navbar-collapse justify-content-end px-0" id="navbarNav">
				<ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
					<a href="#" target="_blank" id="header-bell"><img src="/resources/uploads/member/icon/profile/bell.png" alt="" width="33" height="33"></a>
					<a href="#" target="_blank" id="header-chat"><img src="/resources/uploads/member/icon/profile/message.png" alt="" width="33" height="33"></a>
