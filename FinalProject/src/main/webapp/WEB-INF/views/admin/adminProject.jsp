									...
									<div
										...
										<ul>
											<li
												...
												class="li2">4명</span> <span class="li2">24.01.25</span> <span
												class="li2">1 Month</span> <span class="li2">
											...
											<li
												class="borderDefault visitPadding justifyAround boardLiSize">
												<span class="li1">5</span> <span class="li3">Colaboration
													Code</span> <span class="li4">김창대</span> <span class="li2">4명</span>
												<span class="li2">24.01.25</span> <span class="li2">1
													Month</span> <span class="li2">
													<button class="deleteBtn">삭제</button>
											</span>
											</li>
											<li
